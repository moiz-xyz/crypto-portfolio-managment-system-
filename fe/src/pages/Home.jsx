...
const Home = ({
  ...
  const filteredCoins = coins.filter((coin) => {
    // 🛡️ Guard clause: Skip if the coin object or its strings are missing
    if (!coin || !coin.name || !coin.symbol) return false;
        ...
        <div className="p-4 pb-24 font-sans ">
          <div className="w-full max-w-3xl mx-auto text-center flex flex-col items-center mt-7 sm:mt-12 mb-12 gap-4">
            ...
            <p className="text-md sm:text-lg text-gray-600 dark:text-gray-400">
              Stay updated with real-time cryptocurrency prices and track your
              portfolio.
            </p>
            <Searchbar
              searchValue={search}
